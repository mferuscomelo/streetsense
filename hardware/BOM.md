...
| Sensirion SEN54 (PM + VOC + temp/RH) | 1 | ~$40 | Firmware support is written and builds (`ledglasses_sen54` environment) but not yet run against the physical sensor — it's currently wired into another project. See `docs/future-work.md`. Connects via STEMMA QT / Qwiic-compatible I2C. |
