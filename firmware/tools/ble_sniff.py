...
PACKET_STRUCT = "<BBHHHHHHhHH"  # version,flags,seq,pm1,pm2_5,pm4,pm10,voc,temp,humidity,noise


def decode(raw: bytes) -> dict:
    (version, flags, seq, pm1, pm2_5, pm4, pm10,
     voc, temp, humidity, noise) = struct.unpack(PACKET_STRUCT, raw)
    return {
        "version": version,
